...
function protect(req,res,next){
 ...
 res.render('main')
        ...
        // usermodel.deleteOne({email:"jcbdj@gmail.com"});
            next();
    }
}
function gettemp(req,res){
    // console.log(req.query.email_);
...
try {
    ...
    app.get("/google/callback",passport.authenticate('google',{failureRedirect:'/fail'}),async (req,res)=>{
        let u_id=data.email;
            try {
                google_userdata=u_id;
                ...
                res.redirect(url.format(
                    {
                        pathname:'/main',
                        query:{
                            name:googledata_db.name,  
                            email_:googledata_db.email
                        }
                    }
                ))
            }
